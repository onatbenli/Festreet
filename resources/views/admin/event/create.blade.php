                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <textarea name="pre_description" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <textarea id="editor2" name="rules"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <select name="organizer" class="form-control select2" style="width: 100%;">
                                                    <option selected disabled>Düzenleyici Firma veya Kişiyi Seçiniz</option>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <textarea id="editor3" name="trick"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
